  ...
  <div id="carouselExampleIndicators" class="carousel slide sld1" data-ride="carousel">
   ...
   <div class="carousel-inner">
    <div class="carousel-item active">
     <img class="d-block w-100" src="./projectImages/ImageSlider/tree.jpg" alt="First slide" />
    </div>
    <div class="carousel-item">
     <img class="d-block w-100" src="./projectImages/ImageSlider/one.jpg" alt="Second slide" />
    </div>
    <div class="carousel-item">
     <img class="d-block w-100" src="./projectImages/ImageSlider/six.jpg" alt="Third slide" />
    </div>
    <div class="carousel-item">
